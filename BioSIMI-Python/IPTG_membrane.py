...
model = MB.createNewModel('IPTG_membrane','second','mole','count')
...
simpleModel.createNewSpecies( 'IPTG','external',0,False,'count')
simpleModel.createNewSpecies( 'IPTG','internal',0,False,'count')
simpleModel.createNewSpecies( 'protein alHL*','internal',0,False,'count')
simpleModel.createNewSpecies( 'IPTG:protein alHL*','internal',0,False,'count')
...
# Write to XML file 
writeSBML(MB.getSubsystemDoc(),'models/IPTG_membrane.xml')
